...
import { Users, Activity, ExternalLink, Bookmark, Heart } from 'lucide-react';
...
export default function CommunityCard({ community, matchScore, onSave, onJoin }: CommunityCardProps) {
    ...
    return (
        <div className="glass rounded-xl sm:rounded-2xl p-4 sm:p-6 hover:glass-strong transition-all group">
            {/* Header */}
            ...
            <div className="flex gap-2">
                <button
                    onClick={handleJoin}
                    className="flex-1 px-4 py-2.5 sm:py-2 bg-gradient-to-r from-indigo-600 to-blue-600 rounded-xl font-medium hover:scale-105 transition-transform flex items-center justify-center gap-2 touch-target text-sm sm:text-base"
                >
                ...
                <button
                    onClick={handleSave}
                    className={`px-4 py-2.5 sm:py-2 rounded-xl font-medium transition-all touch-target ${isSaved
