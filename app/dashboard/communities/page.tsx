                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-3 border-b border-white/10 pb-4">
                    <div>
                        <div className="flex items-center gap-2.5 mb-0.5">
                            <div className="w-8 h-8 md:w-9 md:h-9 rounded-xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center text-base md:text-lg">📡</div>
                            <h1 className="text-xl md:text-2xl lg:text-3xl font-black tracking-tight">Community Workspace</h1>
                        </div>
                    ...
                    <div className="flex items-center gap-1 bg-[#1a1a24] p-1 rounded-xl border border-white/10 self-start md:self-auto overflow-x-auto max-w-full scrollbar-hide">
                        {[
                            { id: 'grid', icon: <LayoutGrid className="w-3.5 h-3.5" />, label: 'Discover' },
