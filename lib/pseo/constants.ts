...
export const PERSONAS: PersonaDefinition[] = [
    {
        ...
        description: 'The best directories and communities for startup founders to launch, promote, and grow their products.',
    ...
    },
    {
        ...
        description: 'Top platforms for SaaS marketers to promote products, build backlinks, and reach target audiences.',
...
export const USE_CASES: UseCaseDefinition[] = [
    {
        slug: 'startup',
        label: 'Promote Your Startup',
        description: 'Find the best platforms to promote your startup, get early users, and build traction.',
        keywords: ['startup', 'launch', 'promote'],
        categoryMatch: ['startup directory', 'startup', 'launch'],
    },
    {
        slug: 'saas-product',
        label: 'Promote Your SaaS Product',
        description: 'Discover directories and communities to promote your SaaS product and acquire customers.',
        keywords: ['saas', 'product', 'software'],
        categoryMatch: ['saas', 'software', 'product'],
    },
    {
        slug: 'ai-tool',
        label: 'Promote Your AI Tool',
        description: 'Find the best platforms to launch and promote your AI tool to early adopters.',
